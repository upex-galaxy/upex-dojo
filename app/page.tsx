...
const components = [
  ...
  { name: "Alerts", icon: Icons.alert, href: "/components/feedback/alerts" },
  { name: "Badges", icon: Icons.badge, href: "/components/feedback/badges" },
  { name: "Popovers", icon: Icons.popover, href: "/components/feedback/popovers" },
  ...
  { name: "Breadcrumbs", icon: Icons.breadcrumb, href: "/components/navigation/breadcrumbs" },
  ...
  { name: "Tabs", icon: Icons.tabs, href: "/components/layout/tabs" },
  { name: "Scroll Areas", icon: Icons.scrollArea, href: "/components/layout/scroll-areas" },
  { name: "Separators", icon: Icons.separator, href: "/components/layout/separators" },
